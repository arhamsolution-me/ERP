...
export default function SignInPage() {
  ...
  // Auto pre-fill remembered email if saved in localStorage
  useEffect(() => {
    const savedEmail = localStorage.getItem('nexerp_remembered_email');
    if (savedEmail) {
      setEmail(savedEmail);
      setRememberMe(true);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (rememberMe) {
        localStorage.setItem('nexerp_remembered_email', email);
      } else {
        localStorage.removeItem('nexerp_remembered_email');
      }

      // Step 1: Trigger 3D Right-to-Left Page Flip Animation
      setIsFlipping(true);
  ...
  // Smooth Page Shifting Animation to Register Page
    ...
    <div className="min-h-screen bg-slate-100/80 flex flex-col font-sans selection:bg-blue-600 selection:text-white relative">
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8 my-auto">
        ...
        >
          ...
          {/* LEFT PAGE: Pure Minimalist Logo + Dynamic Graphic Animation */}
          <div
            className={`hidden lg:flex lg:col-span-6 p-8 md:p-12 flex-col items-center justify-between relative bg-gradient-to-b from-slate-50 via-blue-50/20 to-slate-50 border-b lg:border-b-0 lg:border-r border-slate-200/80 z-10 transition-all duration-500 ease-out overflow-hidden ${
              ...
              <div className="w-full relative z-10 space-y-6">
                ...
                <div className="relative h-60 w-full pt-4">
                  <svg className="w-full h-full overflow-visible" viewBox="0 0 500 160" preserveAspectRatio="none">
                    <defs>
                      <linearGradient id="standaloneWaveGrad" x1="0" y1="0" x2="0" y2="1">
          ...
          {/* RIGHT PAGE: Login Form (3D Page Flip Fold on Page Switching or Login Click) */}
          <div
            className={`lg:col-span-6 bg-white relative flex flex-col justify-between p-8 md:p-14 z-30 origin-left transition-all duration-700 ease-in-out ${
          ...
          >
            ...
            <div className="space-y-8 my-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 rounded-xl py-3.5 pl-12 pr-4 text-sm font-normal text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/15 transition-all"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 rounded-xl py-3.5 pl-12 pr-12 text-sm font-normal text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/15 transition-all"
                  />
                  <button
                    type="button"
                ...
                {/* Primary Blue Log In Button */}
                <button
                  type="submit"
                  disabled={loading || isFlipping || isPageSwitching}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold text-base py-3.5 px-4 rounded-xl shadow-md shadow-blue-600/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
              ...
              <div className="relative flex items-center justify-center my-6">
                ...
                <span className="absolute bg-slate-100 px-3 py-1 text-[11px] font-bold text-slate-400 rounded-full uppercase tracking-wider">
                  OR
                </span>
              </div>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-3 px-4 rounded-xl shadow-sm flex items-center justify-center gap-3 transition-colors cursor-pointer text-sm"
                >
